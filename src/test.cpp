...
while(loop) {
    ...
    while (kbhit()==0&&loop!=0) {//test wenn eine Taste gedrueckt wird conio.h)(key board hit)
        ...
        //Auï¿½erdem erzeugt getch() kein Echo auf der Konsole, d.H. der Benutzer
        //sieht nicht was er eingibt (geeignet z.B. fï¿½r kleine Spiele oder die Eingabe eines Passwortes)
        cout <<endl;
        switch(ch)
        {
